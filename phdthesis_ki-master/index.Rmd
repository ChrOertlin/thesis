...
DNA damage response 1","Ribosomal protein S6","Activating transcription factor 4","DNA-inducible gene 34","Coding sequence","Cytoplasmic polyadenylation","Cytoplasmic polyadenylation element binding proteins","Non-canonical poly(A) polymerase","Poly(A) deadynelase","AU-rich element","Mitogen activated protein kinase","Single guide RNA")) %>%
