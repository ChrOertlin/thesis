...
Next to the a prior knowledge of the introduced changes in the simulation data, it also allows us to modify parameters to investigate the robustness of the methods to increased variance, overall sequencing depth and sequencing depth between samples as well as replication. Here, all methods showed robustness against these parameters as long as there was an overall sequencing depth of at least 5 million reads. 
