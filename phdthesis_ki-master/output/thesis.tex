...
in cancer (Saltiel, 2001,Hanahan \& Weinberg (2011)). Insulincan bind to
both IGF1R and INSR that activate the PI3K/AKT/mTOR and RAS/ERK
...
The aim for this study aims to bridge the gap in knowledge by
eludicating the effects of insulin signalling on gene expression using a
luminal A breast cancer cell line (MCF). Using a multi omics approach
including transcriptomics, translatomics and proteomics we capture
multiple steps of the gene expression pathway. Furthermore, to assess to
what extent mRNA translation is involved in the regulation of gene
expression by insulin we evaluate the response to insulin under
conditions where mTOR is activated or suppressed using Torin1, an mTOR
