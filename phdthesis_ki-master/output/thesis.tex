...
\section{mRNA translation}\paragraph{overview of an mRNA}
...
open reading frame (ORF). Redudancy in the codon availability allows
...
cellular cues (see \ref{signalling}). The PIC consists of the
methionyl-initiatior transfer RNA (met-tRNAi) in a ternary complex (TC)
with guanosine triphosphate (GTP) bound eIF2 (Asano, Clayton, Shalev, \&
Hinnebusch, 2000). eIF4F is the translation initation complex containing
three EIFs; eIF4E, the 5' cap binding protein, eIF4G a scaffold protein
and eIF4A and RNA helicase (Grifo et al., 1983,({\textbf{???}})). eIF4F
recruites the PIC to the 5' cap of the mRNA after which scanning for a
start codon (AUG) occurs. After AUG recognition eIF2-GTP is hydrolyzed
forming a stable 48S PIC. Afterrelease of eIF2-GTP the 60S ribosomal
subunit joins to form the 80S ribosome and protein synthesis can
commence (\textbf{Figure \ref{initiation}}).
...
(eRF), eRF2 and eRF3-GTP({\textbf{???}}). A TC containing eRF2 and
...
\paragraph{eIF4A sensitive mRNAs}

can be divided into elements acting on cap dependent and cap-indendent
mRNA translation. Progression of the ribosome is dependent of on eIF4A,
the RNA helicase in the eIF4F complex, that unwinds structural elements
the ribsome encounters(Wolfe et al., 2014,({\textbf{???}})). The
...
using ribosome prolfing (\textbf{see section
\ref{riboseq}})({\textbf{???}},({\textbf{???}})). These studies
identified silvesterol sensitive mRNAs that are characterised by long
and structured 5' UTRs. In addition eIF4A dependent mRNAs were enriched
for having multiple 5' UTR variants, while independet mRNAs were not
({\textbf{???}}). Among eIF4A dependent mRNAs were oncogenes and
transcription factors which makes it attractive for therapy in cancer.
In a different context of eIF4A inhibition using rocaglates polypurine
sequences in the 5' UTR were of importance. Here, rocaglates would clamp
eIF4A to the mRNA causing a road block for ribosome scanning and
premature translation initiation (Iwasaki, Floor, \& Ingolia, 2016).
These mechanisms by which eIF4A inhibition can reduce translation of
mRNAs important in cancer is subject of \textbf{Study 3}, where we apply
CR-1-31-B, a rocaglate, in a pancreatic cancer context.
...
initiation (Haimov, Sinvani, \& Dikstein, 2015). Other notable examples
of regulation of transaltion via 5' UTR features will be discussed in
their relevant context (**see section \ref{signalling}).

\paragraph{Cis element in the 3' UTR}
...
\end{wrapfigure}\paragraph{The relationship between mTOR and metabolsim}
...
(Heerlein, Schulze, Hotz, Bärtsch, \& Mairbäurl, 2005). Interestingly,
mTORC1 is also found to regulatute translation of mRNAs related to
mitochondrial function (\textbf{see section \ref{regmtor})(Larsson et
al., 2012,Gandin et al. (2016b)). The role of cellular metabolism, of
which its deregulation is considered a hallmark of cancer, on mTOR
activity suggests that mRNA translation plays an important role in this
disease (see \ref{translationInCancer}.
\paragraph{Regulation of translation via mTOR} \label{regmtor} can act
on a global level by phosphorylation of 4E-BP1 which facilitates
formation of the eIF4F mRNA translation complex by regulating eIF4E
availability (}see section \ref{initiation}). Selective modulation of
mRNA translation is dependent of 5' UTR characterstics of individual
mRNAs. Transcripts with a terminal oligo pyrimidine (TOP) motif
consisting of a C followed by a stretch of 4-15 pyrimidines directly
after the 5' cap show near complete dissiciation from ribosomes under
conditions when mTOR is inhibited(Yamashita et al., 2008). TOP mRNA are
enriched for genes encoding for parts of the translation machinery
(Thoreen et al., 2012). Recent work indicates the importance of La
ribonucleoprotein domain family member 1 (LARP1) herein. LARP1 is
thought to bind to the 5' mRNA cap of TOP mRNAs via its DM15 domain and
represses translation thereof by obstructing eIF4E binding. mTORC1
physically interacts and phosphorylates LARP1. When phophorylation
occurs close to the DM15 domain of LARP1 the inhibitory effect on mRNA
translation of TOP mRNAs is abolished (Jia et al., 2021). Other
...
addition to mTOR, dependent on either eIF4E or eIF4A. mTOR-eIF4E
sensitive mRNAs show extremely short 5' UTRs and encode for metabolic
functions, whereas mTOR-eIF4A sensitive mRNAs depict long 5' UTRs and
are involved in proliferation and survival (Gandin et al., 2016b).
Therefore, regulation of translation by mTOR can drastically alter gene
expression for various subset of mRNAs involved in different cellular
processes (Hsieh et al., 2012,Larsson et al. (2012),Gandin et al.
(2016b),Thoreen et al. (2012)). \clearpage

\subsection{Cellular stress} \label {ISR}\paragraph{The integrated stress response}
...
overlaps with the mORF. Under normal conditions mRNA translation is
initiated at uORF1 and reinitiation at uORF2 occurs. The close proximity
of uORF2 to the mORF causes ribosomes scan past the mORF start thereby
inhibiting the translation of the coding sequence. Limitiation of TC
availability during ISR causes longer ribosome scanning times (see
section \ref{ISR}. This leads to that ribosomes scan past uORF2 and
...
\hypertarget{ref-Hsieh2012}{}
Hsieh, A. C., Liu, Y., Edlind, M. P., Ingolia, N. T., Janes, M. R.,
Sher, A., \ldots{} Ruggero, D. (2012). The translational landscape of
mTOR signalling steers cancer initiation and metastasis. \emph{Nature},
\emph{485}(7396), 55--61. \url{https://doi.org/10.1038/nature10912}
...
\hypertarget{ref-Larsson2012}{}
Larsson, O., Morita, M., Topisirovic, I., Alain, T., Blouin, M.-J.,
Pollak, M., \& Sonenberg, N. (2012). Distinct perturbation of the
translatome by the antidiabetic drug metformin. \emph{Proceedings of the
National Academy of Sciences of the United States of America},
\emph{109}(23), 8977--8982.
\url{https://doi.org/10.1073/pnas.1201689109}
